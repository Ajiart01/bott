let handler = async (m, { conn, args, usedPrefix, command }) => {
    ...
    switch (type) {
        ...
        case 'serigala':
            ...
            let __waktus = (new Date - db.data.users[m.sender].serigalalastclaim)
            let _waktus = (600000 - __waktus)
            let waktus = clockString(_waktus)
            if (new Date - db.data.users[m.sender].serigalalastclaim > 600000) {
                if (db.data.users[m.sender].makananpet > 0) {
                    db.data.users[m.sender].makananpet -= 1
                    db.data.users[m.sender].anakserigala += 20
                    db.data.users[m.sender].serigalalastclaim = new Date * 1
                    conn.reply(m.chat, `Berhasil memberi makan pet ${type}`, m)
                    setTimeout(() => {
        ...
        case 'naga':
            ...
            let __waktug = (new Date - db.data.users[m.sender].nagalastclaim)
            let _waktug = (600000 - __waktug)
            let waktug = clockString(_waktug)
            if (new Date - db.data.users[m.sender].nagalastclaim > 600000) {
                if (db.data.users[m.sender].makanannaga > 0) {
                    db.data.users[m.sender].makanannaga -= 1
                    db.data.users[m.sender].anaknaga += 20
                    db.data.users[m.sender].nagalastclaim = new Date * 1
                    conn.reply(m.chat, `Berhasil memberi makan pet ${type}`, m)
                    setTimeout(() => {
      ...
      case 'kyubi':
            ...
            if (new Date - db.data.users[m.sender].kyubilastclaim > 600000) {
                if (db.data.users[m.sender].makanankyubi > 0) {
                    ...
                    db.data.users[m.sender].anakkyubi += 20
      ...
      case 'centaur':
            ...
            if (new Date - db.data.users[m.sender].centaurlastclaim > 600000) {
                if (db.data.users[m.sender].makanancentaur > 0) {
                    ...
                    db.data.users[m.sender].anakcentaur += 20
         ...
         case 'phonix':
            ...
            if (new Date - db.data.users[m.sender].phonixlastclaim > 600000) {
                if (db.data.users[m.sender].makananphonix > 0) {
                    ...
                    db.data.users[m.sender].anakphonix += 20
        ...
        case 'griffin':
            ...
            let __waktufin = (new Date - db.data.users[m.sender].griffinlastclaim)
            ...
            if (new Date - db.data.users[m.sender].griffinlastclaim > 600000) {
                if (db.data.users[m.sender].makanangriffin > 0) {
                    ...
                    db.data.users[m.sender].anakgriffin += 20
        ...
        case 'kucing':
            ...
            let __waktu = (new Date - db.data.users[m.sender].kucinglastclaim)
        ...
        case 'hero':
            ...
            let __waktuher = (new Date - db.data.users[m.sender].herolastclaim)
            let _waktuher = (600000 - __waktuher)
            let waktuher = clockString(_waktuher)
            if (new Date - db.data.users[m.sender].herolastclaim > 600000) {
                if (db.data.users[m.sender].pillhero > 0) {
                    db.data.users[m.sender].pillhero -= 1
                    db.data.users[m.sender].exphero += 10 
                    ...
                    if (hero > 0) { 
                        ...
                        if (db.data.users[m.sender].exphero > naiklvl) {
                            ...
                            db.data.users[m.sender].exphero -= (hero * 500)
