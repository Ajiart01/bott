...
if (new Date - db.data.users[m.sender].lastlink > 86800000) {
db.data.users[m.sender].lastlink = new Date * 1
...
conn.reply(m.chat, `
Silahkan klik link berikut untuk mendapatkan hadiah
https://shareduit.pw/gethadiahRaisabot
...
setTimeout(() => {
   conn.sendHydrated(m.chat, 'Selamat kamu mendapatkan hadiah 🎉\nMasukan *${usedPrefix}codeshortlink code', 'klik tombol dibawah untuk menyalin/ meng copy code', null, `${getRandom}`, 'Copy Code', null, null, [[null, null]], m)
