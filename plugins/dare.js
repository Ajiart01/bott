...
"Telponan dengan owner selama 2 jam",
"Foto makanan apapun di dekat anda kirim disini",
"Kirim foto anda yang paling sempurna",
"VN baca surah Al-fatihah",
"Sebutkan makan yang kamu tidak suka",
"Kirim foto mu ke owner dengan caption *ini adalah tantangan*",
"Kirim vn *i love you* ke owner",
"SS chatan doi, atau mantan yang sangat romantis",
"Ajak orang yang tidak kamu kenal, selfie berdua dengan mu lalu kirim ke sini",
"VN *Siapa yang mau jadi pacarku?*"
...
handler.help = ['dare']
handler.tags = ['fun']
handler.command = /^(dare|tantangan)$/i
handler.limit = true
