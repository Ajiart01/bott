...
${isSurrender ? '' : `+${room.winScore} Money tiap jawaban benar`}
    `.trim()
        conn.sendButton(m.chat, caption, wm, 'https://telegra.ph/file/a111cb2779252312d273a.jpg', [['Play Again', '.family100'], ['Menyerah', 'Nyerah']], m, { 
            asLocation: true, mentions: conn.parseMention(caption) 
         }).then(msg => {
