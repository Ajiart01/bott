...
let handler = async (m, { conn, text, usedPrefix, command }) => {
 ...
 let pp = './src/avatar_contact.png'
  try {
    ...
    let health = db.data.users[who].health
    let armor = db.data.users[who].armor 
   // let warn = db.data.users[who].warn
    let pet = db.data.users[who].pet
    let kucing = db.data.users[who].kucing
    let _kucing = db.data.users[who].anakkucing
    let rubah = db.data.users[who].rubah
    let _rubah = db.data.users[who].anakrubah
    let serigala = db.data.users[who].serigala
    let _serigala = db.data.users[who].anakserigala
    let naga = db.data.users[who].naga
    let _naga = db.data.users[who].anaknaga
    let kuda = db.data.users[who].kuda
    let _kuda = db.data.users[who].anakkuda
    let phonix = db.data.users[who].phonix
    let _phonix = db.data.users[who].anakphonix
    let griffin = db.data.users[who].griffin
    let _griffin = db.data.users[who].anakgriffin
    let kyubi = db.data.users[who].kyubi
    let _kyubi = db.data.users[who].anakkyubi
    let centaur = db.data.users[who].centaur
    let _centaur = db.data.users[who].anakcentaur
    let diamond = db.data.users[who].diamond
    let potion = db.data.users[who].potion
    let ramuan = db.data.users[who].ramuan
    let common = db.data.users[who].common
    let makananpet = db.data.users[who].makananpet
    let makanannaga = db.data.users[who].makanannaga
    let makananphonix = db.data.users[who].makananphonix
    let makanangriffin = db.data.users[who].makanangriffin
    let makanankyubi = db.data.users[who].makanankyubi
    let makanancentaur = db.data.users[who].makanancentaur
    let uncommon = db.data.users[who].uncommon
    let mythic = db.data.users[who].mythic
    let legendary = db.data.users[who].legendary
    let sampah = db.data.users[who].sampah
    let anggur = db.data.users[who].anggur
    let jeruk = db.data.users[who].jeruk
    let apel = db.data.users[who].apel
    let mangga = db.data.users[who].mangga
    let pisang = db.data.users[who].pisang
    let bibitanggur = db.data.users[who].bibitanggur
    let bibitjeruk = db.data.users[who].bibitjeruk
    let bibitapel = db.data.users[who].bibitapel
    let bibitmangga = db.data.users[who].bibitmangga
    let bibitpisang = db.data.users[who].bibitpisang 
    let gardenboxs = db.data.users[who].gardenboxs
    let cupon = db.data.users[who].cupon
    let tiketcoin = db.data.users[who].tiketcoin
    let tiketm = db.data.users[who].healtmonster
    let aqua = db.data.users[who].aqua
    let expg = db.data.users[who].expg
    let boxs = db.data.users[who].boxs
    let botol = db.data.users[who].botol
    let kayu = db.data.users[who].kayu 
    let batu = db.data.users[who].batu
    let iron = db.data.users[who].iron
    let sword = db.data.users[who].sword
    let string = db.data.users[who].string
    let kaleng = db.data.users[who].kaleng
    let kardus = db.data.users[who].kardus
    let berlian = db.data.users[who].berlian
    let emas = db.data.users[who].emas
    let emaspro = db.data.users[who].emasbatang
    let hero = db.data.users[who].hero
    let exphero = db.data.users[who].exphero
    let now = new Date() * 1
