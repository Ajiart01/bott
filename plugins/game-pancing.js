...
let handler = async (m, { conn,usedPrefix, command, text, args }) => {
       ...
       let type = (args[0] || '').toLowerCase()
        switch (type) {
	          case 'easy':
                                  let __timers = (new Date - db.data.users[m.sender].lastmancingeasy)
                                  let _timers = (28800000 - __timers)
                                  let timers = clockString(_timers) 
                                  if (pancingan == 0 || umpan == 0) return m.reply('*Kamu belum memiliki Pancingan dan Umpan, Silahkan beli dulu..*')
                                  if (new Date - db.data.users[m.sender].lastmancingeasy > 28800000) {
                                  if (db.data.users[m.sender].pancingan > 1) {
                                  if (db.data.users[m.sender].umpan > 99) {
...
`.trim()
                                 ...
                                 db.data.users[m.sender].umpan -= rbrb13

                                setTimeout(() => {
                                m.reply(`Yuk mancing mania level easy lagi`)
                                }, 28800000) 
                                setTimeout(() => {
                                conn.sendButton(m.chat, hsl, wm, 'https://telegra.ph/file/38c318597992a97e85522.jpg', [['Check Kolam', '.kolam']], m, { asLocation: true })
                                // m.reply(`${hsl}`)
                                }, 12000) 
                                setTimeout(() => {
                                m.reply('Menunggu')
                 ...
                 break
	          case 'normal':
                                  let __timerl = (new Date - db.data.users[m.sender].lastmancingeasy)
                                  let _timerl = (28800000 - __timerl)
                                  let timerl = clockString(_timerl) 
                                  if (pancingan == 0 || umpan == 0) return m.reply('*Kamu belum memiliki Pancingan dan Umpan, Silahkan beli dulu..*')
                                  if (new Date - db.data.users[m.sender].lastmancingeasy > 28800000) {
                                  if (db.data.users[m.sender].pancingan > 2) {
                                  if (db.data.users[m.sender].umpan > 149) {
...
+1 Tiketcoin
`.trim()
                                 db.data.users[m.sender].paus += rbrbs1
                                 db.data.users[m.sender].kepiting += rbrbs2
                                 db.data.users[m.sender].gurita += rbrbs3
                                 db.data.users[m.sender].cumi += rbrbs4
                                 db.data.users[m.sender].buntal += rbrbs5
                                 db.data.users[m.sender].dory += rbrbs6
                                 db.data.users[m.sender].lumba += rbrbs7
                                 db.data.users[m.sender].lobster += rbrbs8
                                 db.data.users[m.sender].hiu += rbrbs9
                                 db.data.users[m.sender].udang += rbrbs10
                                 db.data.users[m.sender].ikan += rbrbs11
                                 db.data.users[m.sender].orca += rbrbs12 
                                 db.data.users[m.sender].tiketcoin += 1
                                 db.data.users[m.sender].umpan -= rbrbs13 
                                 
                                setTimeout(() => {
                                m.reply(`Yuk mancing mania level normal lagi`)
                                }, 28800000) 
                                setTimeout(() => {
                                conn.sendButton(m.chat, hsls, wm, 'https://telegra.ph/file/38c318597992a97e85522.jpg', [['Check Kolam', '.kolam']], m, { asLocation: true })
                                // m.reply(`${hsls}`)
                                }, 12000) 
                                setTimeout(() => {
                                m.reply('Menunggu')
                 ...
                 break 
	          case 'hard':
                                  let __timerh = (new Date - db.data.users[m.sender].lastmancingeasy)
                                  let _timerh = (28800000 - __timerh)
                                  let timerh = clockString(_timerh) 
                                  if (pancingan == 0 || umpan == 0) return m.reply('*Kamu belum memiliki Pancingan dan Umpan, Silahkan beli dulu..*')
                                  if (new Date - db.data.users[m.sender].lastmancingeasy > 28800000) {
                                  if (db.data.users[m.sender].pancingan > 3) {
                                  if (db.data.users[m.sender].umpan > 199) {
...
+1 Tiketcoin
`.trim()
                                 db.data.users[m.sender].paus += rbrbsh1
                                 db.data.users[m.sender].kepiting += rbrbsh2
                                 db.data.users[m.sender].gurita += rbrbsh3
                                 db.data.users[m.sender].cumi += rbrbsh4
                                 db.data.users[m.sender].buntal += rbrbsh5
                                 db.data.users[m.sender].dory += rbrbsh6
                                 db.data.users[m.sender].lumba += rbrbsh7
                                 db.data.users[m.sender].lobster += rbrbsh8
                                 db.data.users[m.sender].hiu += rbrbsh9
                                 db.data.users[m.sender].udang += rbrbsh10
                                 db.data.users[m.sender].ikan += rbrbsh11
                                 db.data.users[m.sender].orca += rbrbsh12 
                                 db.data.users[m.sender].tiketcoin += 1
                                 db.data.users[m.sender].umpan -= rbrbsh13

                                setTimeout(() => {
                                m.reply(`Yuk mancing mania level hard lagi`)
                                }, 28800000) 
                                setTimeout(() => {
                                conn.sendButton(m.chat, hslsh, wm, 'https://telegra.ph/file/38c318597992a97e85522.jpg', [['Check Kolam', '.kolam']], m, { asLocation: true })
                                // m.reply(`${hslsh}`)
                                }, 12000) 
                                setTimeout(() => {
                                m.reply('Menunggu')
                 ...
                 break
	          case 'extreme':
                                  let __timere = (new Date - db.data.users[m.sender].lastmancingeasy)
                                  let _timere = (28800000 - __timere)
                                  let timere = clockString(_timere) 
                                  if (pancingan == 0 || umpan == 0) return m.reply('*Kamu belum memiliki Pancingan dan Umpan, Silahkan beli dulu..*')
                                  if (new Date - db.data.users[m.sender].lastmancingeasy > 28800000) {
                                  if (db.data.users[m.sender].pancingan > 4) {
                                  if (db.data.users[m.sender].umpan > 249) {
...
+1 Tiketcoin
`.trim()
                                 db.data.users[m.sender].paus += rbrbshe1
                                 db.data.users[m.sender].kepiting += rbrbshe2
                                 db.data.users[m.sender].gurita += rbrbshe3
                                 db.data.users[m.sender].cumi += rbrbshe4
                                 db.data.users[m.sender].buntal += rbrbshe5
                                 db.data.users[m.sender].dory += rbrbshe6
                                 db.data.users[m.sender].lumba += rbrbshe7
                                 db.data.users[m.sender].lobster += rbrbshe8
                                 db.data.users[m.sender].hiu += rbrbshe9
                                 db.data.users[m.sender].udang += rbrbshe10
                                 db.data.users[m.sender].ikan += rbrbshe11
                                 db.data.users[m.sender].orca += rbrbshe12 
                                 db.data.users[m.sender].tiketcoin += 1
                                 db.data.users[m.sender].umpan -= rbrbshe13

                                setTimeout(() => {
                                m.reply(`Yuk mancing mania level extreme lagi`)
                                }, 28800000) 
                                setTimeout(() => {
                                conn.sendButton(m.chat, hslse, wm, 'https://telegra.ph/file/38c318597992a97e85522.jpg', [['Check Kolam', '.kolam']], m, { asLocation: true })
                                // m.reply(`${hslse}`)
                                }, 12000) 
                                setTimeout(() => {
                                m.reply('Menunggu')
