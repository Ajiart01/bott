let handler = async (m, { conn, participants, groupMetadata }) => {
    ...
    try {
        ...
        let { expired, viewonce, antiSticker, antiBadword, isBanned, welcome, detect, sWelcome, sBye, sPromote, sDemote, antiLink } = db.data.chats[m.chat]
...
${welcome ? '✅' : '❌'} Welcome
${detect ? '✅' : '❌'} Detect
${db.data.chats[m.chat].delete ? '❌' : '✅'} Anti Delete
${antiLink ? '✅' : '❌'} Anti Link
