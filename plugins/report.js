...
let handler = async(m, { conn, text, usedPrefix, command}) => {
    ...
    conn.reply('6285163999446@s.whatsapp.net', teks1, m)
    conn.reply(m.chat, '✔️ Masalah berhasil dikirimkan ke Owner, Report ga jelas = banned!! buang buang waktu owner :D', m)
}
